...
module.exports.run = async (client, message, args) => {
    ...
    let embed = new Discord.RichEmbed()
        ...
        .setTitle("Info")
        .setDescription("Hi! I am a complete moderation bot made by C4Navar(316641074967871500). If you have any questions/feedbacks please visit my Discord Server: \n **Future Plans:**\n *Database System soon:tm:\n*With database, more commands soon:tm:")
